...
export default function HomeScreen() {
  ...
  const { isAuthenticated, accessToken, userName, email } = useAuth();
  ...
  const watchlistItems = dashboardData?.watchlistItems ?? [];
  const displayName =
          ...
          <View style={styles.toolsWrap}>
            ...
            {showTools && (
              <View style={styles.toolsDropdown}>
                ...
                >
                  <Text style={styles.toolsRowText}>Spike Alert Settings</Text>
      ...
      <View style={styles.content}>
              ...
              <>
                <View style={styles.panelCard}>
                  <View style={styles.panelHeader}>
                    ...
                    <TouchableOpacity onPress={() => router.push("/alert-settings")}>
        ...
        <View style={styles.featureGrid}>
          ...
          <FeatureCard
            ...
            color="#D97706"
            bg="#FEF3C7"
            link={isAuthenticated ? "/alert-settings" : "/signup"}
          />
        </View>
        ...
        <View style={styles.bannerCard}>
          ...
          <Link href={isAuthenticated ? "/learn" : "/signup"} asChild>
